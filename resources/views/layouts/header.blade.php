...
<header class="header-area2 style-2">
    <div class="header-logo">
        <a href="index.html"><img alt="image" class="img-fluid" src="{{ asset('assets/headernexologo.svg') }}"></a>
    </div>
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <a href="index.html"><img alt="image" src="{{ asset('assets/headernexologo.svg') }}"></a>
            </div>
        </div>
        <ul class="menu-list">
            ...
            <li class="menu-item-has-children">
                <a href="#" class="drop-down">Packages</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    <li><a href="pricing.html">SEO Package</a></li>
                            <li><a href="pricing2.html">Web Design Package</a></li>
                            <li><a href="pricing2.html">Social Media Package</a></li>
                            <li><a href="pricing2.html">PPC Package</a></li>
                </ul>
            </li>
            <li class="menu-item-has-children">
                <a href="#" class="drop-down">Work</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    <li><a href="pricing.html">Our Clients</a></li>
                            <li><a href="pricing2.html">Latest SEO Results</a></li>
                            <li><a href="pricing2.html">Web Design Work</a></li>
                            <li><a href="pricing2.html">Testimonials</a></li>
                </ul>
            </li>
