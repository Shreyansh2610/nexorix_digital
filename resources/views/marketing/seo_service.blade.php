...
@section('content')
                ...
                <div class="row g-lg-4 gy-5 my-5">
                    ...
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="case-content">
                            <h2 class="text-success-theme">Get Professional SEO Services in India</h2>
                            <p class="text-white">Having a website without optimizing it for the search engine is like
                                creating a product but not telling about it to the world. If you have a business today and
                                there is no presence online, you ignore a bigger set of potential customers. So, opting for
                                a full package of Digital Marketing Services is a smart decision.
                            </p>
                            <p class="text-white">
                                We are a renowned SEO company in India with a strong team of SEO experts and analysts. With
                                us, you can choose from our various SEO packages designed to cater to small and large
                                business. Get connected with a professional team who are delivering the best SEO services
                                over the years.
                            </p>
                            <a href="" class="btn btn-success my-5">SEO Cost Calculator</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5 bg-dark-2">
        <div class="container">
            <div class="row g-lg-4 gy-5 my-5">
                <div class="col-lg-6 d-flex order-2 order-md-1 align-items-center">
                    <div class="case-content">
                        <h2 class="text-white">Global SEO Services</h2>
                        <p class="text-white">
                            It does not matter where is your business located; the best thing about us is that we can help
                            you optimize your website like your local service provider. We are a global digital marketing
                            company with an able SEO expert team. Connect with us today to increase website traffic, drive
                            conversions and get revenue.
                        </p>
                        {{-- <a href="" class="btn btn-success my-5">SEO Cost Calculator</a> --}}
                    </div>
                </div>
            ...
            <div class="row g-lg-4 gy-5 my-5">
                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="case-content">
                        <h2 class="text-white">Local SEO Services</h2>
                        <p class="text-white">
                            Are you still confused about what local SEO means? Local SEO is an effective way to promote your
                            business through the internet. It is a powerful way of connecting you to the local customers. We
                            are a local SEO expert and use various strategies to rank your site in your target region.
                        </p>
                        {{-- <a href="" class="btn btn-success my-5">SEO Cost Calculator</a> --}}
                    </div>
                </div>
            ...
            <div class="row g-lg-4 gy-5 my-5">
                <div class="col-lg-6 order-2 order-md-1 d-flex align-items-center">
                    <div class="case-content">
                        <h2 class="text-white">E-commerce SEO Services</h2>
                        <p class="text-white">
                            Do you have an Ecommerce business with low sales? With high competition in the sector, no
                            ecommerce business seems to flourish if it isn't promoted well. We've polished our expertise as
                            one of the Best SEO company in India, offering customized packages for Ecommerce SEO Services.
            ...
            <div class="row g-lg-4 gy-5 my-5">
                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="case-content">
                        <h2 class="text-white">Google Map Marketing</h2>
                        <p class="text-white">
                            We offer a fully optimized Google Map Marketing service to help your customers find you easily.
                            If you want to beat your industry competitors online, then Google Map Marketing is one of the
                            weapons to use. Ask our experts about how we have been helping brands go visible on Google
                            Business Listing.
                        </p>
                        {{-- <a href="" class="btn btn-success my-5">SEO Cost Calculator</a> --}}
                    </div>
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-12">
                <h1 class="fw-bold text-success-theme text-center mb-5">Our Latest SEO Results</h1>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-success table-bordered table-striped">
                        <thead class="table-light">
                            <tr>
                                <th colspan="100%" class="bg-success-grad text-center">Skin Care Clinic | Google.com.au</th>
                            </tr>
                            <tr class="">
    ...
    <div class="home3-solution-section p-5">
        <div class="container-fluid px-md-5">
            <h1 class="text-center text-success-theme my-5">SEO India Process</h1>
            <div class="row row-cols-md-4 row-cols-md-3 row-cols-sm-2 row-cols-1 gy-5 d-flex card-streched">
                <div class="col wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        <div class="icon">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">SEO Audit</a></h4>
                            <p>We perform advance SEO audit before we begin the on-page and off-page SEO activities. All
                                audit reports are auto-generated through globally authorized tools.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        <div class="icon">
                            <svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="solution-content">
                            ...
                            <p>Knowing the right keyword is essential to target your potential customers. We finalize a set
                                of keywords we will be targeting to optimize your website.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        <div class="icon">
                            <svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">Competitor Analysis</a></h4>
                            <p>We keep a constant eye on what your competitors are doing. To beat your competitors, we
                                monitor their SEO performances daily.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">Content Creation</a></h4>
                            <p>Since content plays a significant role in SEO, we have a pool of in-house content writers, &
                                editors who manage seo content.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">On-Page SEO</a></h4>
                            <p>We help Google identify and crawl your website by doing quality on-page SEO. Right on-page
                                SEO helps search engines recognize the keywords you want to rank for.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">Off-Page SEO</a></h4>
                            <p>Our off-page operational team work on quality link building, blog posting, and forum posting
                                to optimize your website for search engines.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">Content Strategy</a></h4>
                            <p>From time to time, content strategies are revised depending upon your website's performance
                                on search engines.</p>
                        </div>
                    </div>
                </div>
                <div class="col wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="solution-card h-100 magnetic-item">
                        ...
                        <div class="solution-content">
                            <h4><a href="service-details.html">Reporting & Tracking</a></h4>
                            <p>A monthly report is shared with you that includes details of on-page and off-page activities
                                done. The SEO Report shows the position of your website on search engines.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="home4-trusted-client-area mt-0 mx-0 px-0">
                ...
                <div class="marque-wrap mb-4">
                    <div class="marquee_text gap-3">
                        ...
                        <div class="mx-3 single-client bg-white rounded-3">
                            <img class="img-fluid" src="{{ asset('assets/img/feature/bdaily-logo.webp') }}"
                                alt="">
                        </div>
                        <div class="mx-3 single-client bg-white rounded-3">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card3">
                                    ...
                                    <div class="testimonial-content">
                                        ...
                                        <p>“Website and SEO are amazing, Get daily 1 to 4 online website inquiry daily.
                                            Thank you guys.”</p>
                                    </div>
    ...
    <div class="faq-page py-5 bg-dark">
        <div class="container">
            <div class="row gy-5 justify-content-center">
                <div class="col-12 pt-5 pb-3 text-center">
                    <p class="fs-1 fw-bold text-white">SEO Ahmedabad FAQ's</p>
                    <p class="fs-1 text-success-theme">Have any questions?</p>
                </div>
                <div class="col-12 col-md-12">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-paneW show" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="accordion" id="accordionExample1">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            Availing SEO service from best SEO Services India will help you optimize your website for search engines. A website without SEO optimization, is just an identity giving no result.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Why should I Choose Thanksweb for SEO?
                                        </button>
                                    </h5>
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            We are a renowned SEO Company India with a team of experienced SEO experts. For years we have been servicing clients across the globe from the various niche. Our clients asking for renewal is proof that we have been delivering as per the expectation.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            White Hat SEO is an SEO technique that is done following the search engine's terms and conditions. This also includes submitting quality content, the website's fast loading speed, building a responsive website, etc.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Yes, SEO can help. However, if you need urgent leads, you can opt for pay per click service or social media marketing services.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            On-Page SEO refers to optimizing the website for higher ranking on the search engine. It also refers to content and HTML code.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Off-Page SEO refers to submissions done on a third party website for higher ranking on the search engine.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSeven" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            By doing quality SEO submission, we can help you improve the website authority. Since we follow white hat SEO technique, improving website authority comes easy to us.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingEight">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            What are the type of SEO?
                                        </button>
                                    </h5>
                                    <div id="collapseEight" class="accordion-collapse collapse"
                                        aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            In current SEO trends there are 3 main type of SEO: Onpage SEO, Offpage SEO, and Technical SEO.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingNine">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            How expensive is SEO service?
                                        </button>
                                    </h5>
                                    <div id="collapseNine" class="accordion-collapse collapse"
                                        aria-labelledby="headingNine" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Our SEO packages are pocket friendly and are designed to suit every business. We are known as an affordable SEO Company for offering Cheap SEO Packages in India. Our packages start from 7999 INR. Per Month.
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{-- <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingTen">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            How long does keyword take to rank?
                                        </button>
                                    </h5>
                                    <div id="collapseTen" class="accordion-collapse collapse"
                                        aria-labelledby="headingTen" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Depending upon the competition of your website's keyword and health, it
                                            can
                                            take a minimum of 4 to 6 months for your website to rank on the search
                                            engine.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingEleven">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            How can I trust you will get me good SEO results?
                                        </button>
                                    </h5>
                                    <div id="collapseEleven" class="accordion-collapse collapse"
                                        aria-labelledby="headingEleven" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            We understand it isn't easy to trust when there are numerous SEO
                                            Companies
                                            in Ahmedabad. Please don't go by our word! See the results our SEO
                                            experts
                                            have achieved for our existing clients. Feel free to speak to our
                                            current
                                            clients and decide.
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingTwelve">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            What are your charges for SEO services?
                                        </button>
                                    </h5>
                                    <div id="collapseTwelve" class="accordion-collapse collapse"
                                        aria-labelledby="headingTwelve" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            If you have been looking for SEO Services in Ahmedabad and want to know
                                            about <span class="text-success-theme">affordable SEO packages</span>,
                                            get
                                            in touch with us. Every business is
                                            different and needs different efforts to gain growth. A quick health
                                            check
                                            of your website will allow us to share costing.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="headingThirteen">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Is SEO service better than paid advertising?
                                        </button>
                                    </h5>
                                    <div id="collapseThirteen" class="accordion-collapse collapse"
                                        aria-labelledby="headingThirteen" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            SEO is a long-term tactic aimed at improving your website's visibility
                                            in
                                            organic search results. However, it may take some time for the results
                                            to be
                                            apparent. Paid advertising, on the other hand, might help you reach your
                                            audience quickly. It has the potential to produce quick results and
                                            boost
                                            brand awareness right away. However, it can be expensive, and you need
                                            to
                                            keep investing in maintaining visibility.
                                        </div>
                                    </div>
                                </div> --}}
                            </div>
